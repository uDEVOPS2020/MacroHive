        ...
        if "info" in filename:
            ...
            for service in nodes:
                if check_service_fails(service, pd.read_csv(info_out_file)):
                    ...
                    filtered_samples = filtered_samples.loc[filtered_samples > 1.5].index.values.tolist()
            ...
            #non utilizzato (cause-effetti in formato json)
            # jsonString = json.dumps(causes_dict, indent=4)
            # print(jsonString)
